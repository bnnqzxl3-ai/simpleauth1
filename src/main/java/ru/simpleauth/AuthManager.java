...
public class AuthManager {
    ...
    public void onJoin(ServerPlayerEntity player) {
        ...
        p.wasAllowFlying = player.getAbilities().allowFlying;
        p.wasFlying = player.getAbilities().flying;
    ...
    private void unlock(ServerPlayerEntity player) {
        ...
        // забираем полёт и возвращаем гравитацию
        player.setNoGravity(false);
        player.getAbilities().allowFlying = p != null && p.wasAllowFlying;
        player.getAbilities().flying = p != null && p.wasFlying;
        player.sendAbilitiesUpdate();
