...
public class SimpleAuth implements DedicatedServerModInitializer {
    ...
    public void onInitializeServer() {
        ...
        ServerMessageEvents.ALLOW_CHAT_MESSAGE.register((message, sender, params) -> {
            ...
            // Префикс в чате. Остальным игрокам чат идёт как обычно —
            // перехватываем только тех, у кого префикс задан.
            String name = sender.getGameProfile().getName();
            Text prefix = manager.prefixFor(name);
            if (prefix != null && sender.getServer() != null) {
